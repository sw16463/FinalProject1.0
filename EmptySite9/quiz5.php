            ...
            <div class="well">
                <div style="text-align: center">
                      ...
                      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">                   
                        ...
                        <h4>Ideas are often more important than real things.</h4>
                        ...
                        <br><br>
                        <h4>You find it easy to support your friends emotionally.</h4>
                        ...
                        <br><br>
                        <h4>You rarely overthink your tasks or projects.</h4>
                        ...
                        <br><br> 
                        <h4>You oftentimes let your emotions show, when you are with close friends.</h4>
                        ...
                        <br><br>
                        <h4>It is not difficult to keep a cool head in conflict situations.</h4>
                        ...
                        <br><br>
                        <h4>You enjoy thinking about what impact current events could have on something far away in the future.</h4>
                      ...
                      <ul class="pagination">
                      <li><a href="quiz4.php">&laquo;</a></li>
                      ...
                      <li><a href="profile.php">&raquo;</a></li>
                      </ul>
                      <?php
                                ...
                                *************************************************************************/                
                                ...
                                $strSQL = "UPDATE personality_quiz   
                                            SET N_S_score = N_S_score + $Intuitive,
