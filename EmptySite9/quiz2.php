            ...
            <div class="well">
                  <div style="text-align: center">
                      ...
                      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">                   
                           ...
                           <h4>It is rather easy to excite you.</h4>
                           ...
                           <br><br>
                           <h4>People often say that you are inflexible.</h4>
                           ...
                           <br><br>
                           <h4>Emotional movies can easily make you sad.</h4>
                           ...
                           <br><br> 
                           <h4>Your home and work environments are quite tidy.</h4>
                           ...
                           <input type="radio" name="fourthQ" value="5" <?php if (isset($fourthQ) && $fourthQ=="5") echo "checked";?>>5
                            ...
                            <br><br>
                           <h4>You often feel as if you have to defend your principles and ideas.</h4>
                           ...
                           <input type="radio" name="fifthQ" value="5" <?php if (isset($fifthQ) && $fifthQ=="5") echo "checked";?>>5
                            ...
                            <br><br>
                           <h4>You are often accused of being very decisive.</h4>
                      ...
                      <ul class="pagination">
                          ...
                          <li><a href="quiz3.php">&raquo;</a></li>
                      </ul>
                    ...
                    <?php
                                ...
                                *************************************************************************/                
                                ...
                                $Intuitive = $firstQ;
                                $Feeling = $thirdQ;
                                $Judging = $secQ + $fourthQ + $fifthQ + $sixQ;
                                echo $Intuitive;
                                echo $Feeling;
                                echo $Judging;
